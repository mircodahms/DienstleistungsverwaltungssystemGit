...
$rs=$obj->showDiensteAttribute($dienstname);
$res=$rs->fetch_object();
...
if(isset($_POST['submit'])){
    ...
    foreach ($array as $key => $value) {
        $value = $_POST[$key];
        $sql = "ALTER TABLE $dienstname CHANGE $key $value varchar(255)";
        $conn->query($sql);
    };
        $conn->close();
                            ...
                            <div class="col-lg-10">
                                <div class="form-group">
                                    ...
                                    foreach ($array as $key => $value) {?>
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" name="<?php echo $key;?>" id="Dienstleistungsbezeichnung"  value="<?php echo $key;?>" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6"><br><br>
                                            <input type="submit" class="btn btn-primary" name="submit" value="Attribute umbenennen"></button>
                                        </div>
                                    </div>
